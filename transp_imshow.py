...
# https://github.com/RemiLehe/transparent_imshow/blob/master/transparent_imshow/transparent_imshow.py

def transp_imshow( ax, data, tvmin=None, tvmax=None, tmax=1.,
