...
* Install [Miniconda](https://docs.anaconda.com/miniconda/miniconda-install/ target="_blank") for Linux in ```<INSTALL_DIR>```. Please note that Musclesense requires Python version > 3.12.
